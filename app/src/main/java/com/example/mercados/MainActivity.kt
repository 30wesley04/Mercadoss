    ...
    private fun getLocation() {
        fusedLocationProviderClient.lastLocation?.addOnSuccessListener {
            if (it == null) {
                Toast.makeText(
                    this,
                    "Lo sentimos, no se puede obtener la ubicacion",
                    Toast.LENGTH_LONG
                ).show()
            } else it.apply {
    ...
    fun clickBtnInsertar(view: View) {
        ...
        val stringRequest = object : StringRequest(
            ...
            override fun getParams(): Map<String, String> {
                ...
                params.put("mercado", spinner.selectedItem.toString())
                params.put("localmdo", localEdit?.text.toString())
                params.put("latitud", latitudeU.toString())
                params.put("longitud", longitudeU.toString())
                params.put("activo", activo.toString())
                return params
            }
        }
